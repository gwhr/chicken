  ...
  <div>
      ...
      <div class="register">
          <div class="registerForm">
              <ul>
                  <li class="form_li">
                      <input class="form-control"  :placeholder="$t('info.entername')" v-model="registers.Alipayaccount">
                  </li>
                 <li class="form_li">
                      <input class="form-control" type="number" :placeholder="$t('info.Alipayname')" v-model="registers.Alipayname">
                  </li>
                  <li class="form_li">
                     <div class="shangchuan">
                         <input type="file" class='submit'>
